...
**Testing:** 138 tests covering models, grouping logic, goal settings, edit/delete, statistics, streaks, undo/trash, CSV export, notifications, widget, and reduction plan.
...
└── PuffwiseTests/
    └── PuffwiseTests.swift  # Comprehensive test suite (138 tests)
```
