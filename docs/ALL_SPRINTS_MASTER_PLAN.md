...
- **Outcome**: ReductionPlan model with compounding reduction, effective daily goal accounting for puffs already logged in the week, settings UI in GoalSettingsView, and LineMark trajectory chart on the home screen. 140 tests passing (31 new).
- **Lessons Learned**:
